...
$query->execute();
$_SESSION['msg']="Información del libro actualizada con éxito";
...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Actualizar libro</h4>
...
<p class="help-block"></p>
 ...
 <div class="form-group">
 <label>Link de descarga<span style="color:red;">*</span></label>

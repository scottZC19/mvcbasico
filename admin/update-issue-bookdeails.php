...
$_SESSION['msg']="Libro devuelto con éxito";
...
<head>
    ...
    <title>Sistema de gestión de bibliotecas en línea | Detalles del libro emitido</title>
...
<div class="form-group">
<label>Fecha de emisión del libro :</label>

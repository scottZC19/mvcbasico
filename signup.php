...
if($lastInsertId)
{
echo '<script>alert("Su registro fue exitoso y su identificación de estudiante es  "+"'.$StudentId.'")</script>';
}
else 
{
...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>Sistema de gestión de bibliotecas Cafeina incluida</title>
